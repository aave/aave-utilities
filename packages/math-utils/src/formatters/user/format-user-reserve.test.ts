...
describe('formatUserReserve', () => {
  ...
  it('should format a user reserve ', () => {
    ...
    expect(formattedReserve.underlyingBalanceUSD).toEqual('2446.62265827');
    ...
    expect(formattedReserve.totalBorrowsUSD).toEqual('52.4327211');
    ...
    expect(formattedReserve.variableBorrowsUSD).toEqual('52.4327211');
  });
});
