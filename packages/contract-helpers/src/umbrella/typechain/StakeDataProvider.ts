...
export type StataTokenDataStruct = {
  asset: string;
  assetName: string;
  assetSymbol: string;
  aToken: string;
...
export type StataTokenDataStructOutput = [
  string,
  string,
  string,
  string,
...
export type StakeDataStruct = {
  ...
  stataTokenData: StataTokenDataStruct;
...
export type StakeDataStructOutput = [
  ...
  underlyingIsStataToken: boolean;
  stataTokenData: StataTokenDataStructOutput;
...
export type StakeUserBalancesStruct = {
  ...
  stataTokenAssetBalance: BigNumberish;
  stataTokenATokenBalance: BigNumberish;
};
...
export type StakeUserBalancesStructOutput = [
  ...
  stataTokenAssetBalance: BigNumber;
  stataTokenATokenBalance: BigNumber;
};
