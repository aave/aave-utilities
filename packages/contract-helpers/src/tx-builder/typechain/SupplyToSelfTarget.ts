...
export interface SupplyToSelfTargetInterface extends utils.Interface {
  functions: {
...
export interface SupplyToSelfTarget extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SupplyToSelfTargetInterface;
