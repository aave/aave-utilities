    ...
    it('should not throw', async () => {
      ...
      expect(result).toEqual({
        reservesData: [
          ...
          {
            originalId: 2,
            id: '137-0x40d16fc0246ad3160ccc09b8d0d3a2cd28ae6c2f-0x88757f2f99175387ab4c6a4b3067c77a695b0349',
            underlyingAsset: '0x40d16fc0246ad3160ccc09b8d0d3a2cd28ae6c2f',
            name: '',
            symbol: 'GHO',
            decimals: 0,
            baseLTVasCollateral: '0',
            ...
            unbacked: '0',
            isolationModeTotalDebt: '0',
            debtCeilingDecimals: '20000000000000000000000000',
            borrowableInIsolation: false,
            flashLoanEnabled: false,
            virtualAccActive: false,
            virtualUnderlyingBalance: '0',
