...
import { IUiPoolDataProvider } from './IUiPoolDataProvider';

export class IUiPoolDataProviderFactory {
  static connect(
    address: string,
    ...
    return (new Contract(
      ...
      _abi,
      signerOrProvider,
    ) as unknown) as IUiPoolDataProvider;
  }
}
