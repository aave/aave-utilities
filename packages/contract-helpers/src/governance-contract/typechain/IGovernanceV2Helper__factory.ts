...
import type {
  IGovernanceV2Helper,
  IGovernanceV2HelperInterface,
} from './IGovernanceV2Helper';
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType:
          'struct IGovernanceV2Helper.DelegateTokensByTypeBySigData[]',
        name: 'data',
        type: 'tuple[]',
      },
    ],
...
export class IGovernanceV2Helper__factory {
  ...
  static createInterface(): IGovernanceV2HelperInterface {
    return new utils.Interface(_abi) as IGovernanceV2HelperInterface;
  }
  static connect(
    address: string,
