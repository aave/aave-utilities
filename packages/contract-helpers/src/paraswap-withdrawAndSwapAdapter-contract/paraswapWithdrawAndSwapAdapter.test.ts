...
describe('WithdrawAndSwapAdapterService', () => {
  ...
  describe('Initialization', () => {
    ...
    it('Expects to initialize without withdrawSwapAdapterAddress', () => {
  ...
  describe('withdrawAndSwap', () => {
    ...
    it('Expects the tx object when sending all correct params with swap all true', async () => {
      ...
      expect(tx.to).toEqual(withdrawAndSwapAdapterAddress);
    ...
    it('Expects to fail if swapCollateralAdapterAddress not provided', () => {
      const swapInstance = new WithdrawAndSwapAdapterService(provider);
      const txObj = swapInstance.withdrawAndSwap({
        user,
        assetToSwapFrom,
        assetToSwapTo,
        amountToSwap,
