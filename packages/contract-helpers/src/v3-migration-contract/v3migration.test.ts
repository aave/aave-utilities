...
//       },
//     ];
//     const supplyAssetsStableVariable = [
//       {
//         rateMode: InterestRate.Stable,
//         underlyingAsset: '0x0000000000000000000000000000000000000004',
//         deadline: 123,
...
//       },
//     ];
//     it('Exepects to work with params no sig no approvals', async () => {
//       const instance = new V3MigrationHelperService(
//         provider,
//         MIGRATOR_ADDRESS,
//         pool,
...
//     it('Expects to work with params and sig and variable debt', async () => {});
