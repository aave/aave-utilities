...
transactions based on method and parameter inputs. It can be used to read and
write data to the on-chain protocol contracts.
...
- [Data Formatting Methods](#data-formatting-methods)
  - [Fetching Protocol Data](#fetching-protocol-data)
    - [ethers.js](#ethersjs)
    - [Subgraph](#subgraph)
